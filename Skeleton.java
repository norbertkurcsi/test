...
public class Skeleton {
    /**
     * Jelzi, hogy a konzolra való kiírás során mekkora az aktuális indentálás mértéke.
     */
    ...
    static public void callFunction(Object object, String functionName, Object[] params) {
        ...
        if (params != null) {
            // Összefűzzük a metódushívás paramétereit, az objektumokat vesszővel elválasztva
     ...
     * Csökkentjük az indentet, és kiírjuk az metódushívás befejeződését jelző karaktert.
     */
     ...
     * Addig folytatja a kérdés kiírását, ameddig a felhasználó nem ad egy, a formátumnak megfelelő választ
     ...
     * Amennyiben a felhasználó válasza nem egy érvényes szám, a kérdés megismétlődik.
     * @param message A kérdés szövege
